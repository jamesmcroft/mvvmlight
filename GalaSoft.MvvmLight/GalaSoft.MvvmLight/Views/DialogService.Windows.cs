// ****************************************************************************
// <copyright file="DialogService.Windows.cs" company="GalaSoft Laurent Bugnion">
...
namespace GalaSoft.MvvmLight.Views
{
    ...
    public class DialogService : IDialogService
    {
        ...
        {
            MessageDialog dialog = this.CreateDialog(message, title, buttonText, null, afterHideCallback);
        ...
        {
            MessageDialog dialog = this.CreateDialog(error.Message, title, buttonText, null, afterHideCallback);
            await dialog.ShowAsync();
        }
        ...
        {
            MessageDialog dialog = this.CreateDialog(message, title);
            await dialog.ShowAsync();
        }
            ...
            Action<bool> afterHideCallback)
        {
            ...
            MessageDialog dialog = this.CreateDialog(
                message,
                title,
                buttonConfirmText,
                buttonCancelText,
