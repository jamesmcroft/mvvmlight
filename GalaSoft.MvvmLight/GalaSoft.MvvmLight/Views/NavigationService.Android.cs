// ****************************************************************************
// <copyright file="NavigationService.Android.cs" company="GalaSoft Laurent Bugnion">
...
namespace GalaSoft.MvvmLight.Views
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        /// </summary>
        public string CurrentPageKey => ActivityBase.CurrentActivity.ActivityKey ?? RootPageKey;
        ...
        public void Configure(string key, Type activityType)
        {
            lock (this.pagesByKey)
            {
                ...
                {
                    this.pagesByKey[key] = activityType;
                }
                else
                {
                    this.pagesByKey.Add(key, activityType);
                }
            }
        }
        ...
        public object GetAndRemoveParameter(Intent intent)
        {
            ...
            lock (this.parametersByKey)
            {
                if (this.parametersByKey.ContainsKey(key))
                {
                    var param = this.parametersByKey[key];
                    this.parametersByKey.Remove(key);
                    return param;
                }
        ...
        {
            return (T)this.GetAndRemoveParameter(intent);
        }
        ...
        public void NavigateTo(string pageKey, object parameter)
        {
            ...
            lock (this.pagesByKey)
            {
                ...
                var intent = new Intent(ActivityBase.CurrentActivity, this.pagesByKey[pageKey]);
                ...
                if (parameter != null)
                {
                    lock (this.parametersByKey)
                    {
                        ...
                        this.parametersByKey.Add(guid, parameter);
