// ****************************************************************************
// <copyright file="Extensions.Xamarin.cs" company="GalaSoft Laurent Bugnion">
...
namespace GalaSoft.MvvmLight.Helpers
{
    ...
    public static class Extensions
    {
            ...
            Binding commandParameterBinding)
        {
            ...
            EventInfo e = t.GetEventInfoForControl(eventName);

            var castedBinding = (Binding<T, T>)commandParameterBinding;

            Delegate handler = e.GetCommandHandler(eventName, t, command, castedBinding);
            ...
            PropertyInfo enabledProperty = t.GetProperty("Enabled");
            ...
            Binding commandParameterBinding)
        {
            ...
            {
                T param = castedBinding == null ? default(T) : castedBinding.Value;
        ...
        /// <param name="eventName">The name of the event that will be subscribed to to actuate the command.</param>
        /// <param name="command">The command that must be added to the element.</param>
        public static void SetCommand(this object element, string eventName, ICommand command)
        {
            Type t = element.GetType();
            EventInfo e = t.GetEventInfoForControl(eventName);

            Delegate handler = e.GetCommandHandler(eventName, t, command);
            ...
            if (enabledProperty != null)
            {
                ...
                command.CanExecuteChanged += (s, args) => enabledProperty.SetValue(element, command.CanExecute(null));
            }
        }
        ...
        /// <param name="eventName">The name of the event that will be subscribed to to actuate the command.</param>
        /// <param name="command">The command that must be added to the element.</param>
        public static void SetCommand<TEventArgs>(this object element, string eventName, ICommand command)
        {
            Type t = element.GetType();
            EventInfo e = t.GetEventInfoForControl(eventName);
            ...
            T commandParameter)
        {
            ...
            Delegate handler = e.GetCommandHandler(eventName, t, command, commandParameter);
        ...
        /// will be observed and changes will be passed to the command, for example to update the CanExecute.</param>
#endif
        public static void SetCommand<T>(this object element, RelayCommand<T> command, Binding commandParameterBinding)
        {
        ...
        /// <param name="command">The command that must be added to the element.</param>
#endif
        public static void SetCommand(this object element, ICommand command)
        {
        ...
        /// <param name="command">The command that must be added to the element.</param>
#endif
        public static void SetCommand<TEventArgs>(this object element, ICommand command)
        {
        ...
        /// overloads that uses a Binding as CommandParameter.</param>
#endif
        public static void SetCommand<T>(this object element, RelayCommand<T> command, T commandParameter)
        {
        ...
        /// overloads that uses a Binding as CommandParameter.</param>
#endif
        public static void SetCommand<T, TEventArgs>(this object element, RelayCommand<T> command, T commandParameter)
        {
