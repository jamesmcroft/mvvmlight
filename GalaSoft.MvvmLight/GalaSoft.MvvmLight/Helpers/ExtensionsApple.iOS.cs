// ****************************************************************************
// <copyright file="ExtensionsApple.iOS.cs" company="GalaSoft Laurent Bugnion">
...
namespace GalaSoft.MvvmLight.Helpers
{
    ...
    public static class ExtensionsApple
    {
            ...
            where TCell : UICollectionViewCell
        {
            ...
            ObservableCollectionViewSource<TItem, TCell> coll = factory();
            ...
            Func<ObservableTableViewSource<TItem>> factory = null)
        {
            if (factory != null)
            {
                ObservableTableViewSource<TItem> coll = factory();
                coll.DataSource = list;
                coll.BindCellDelegate = bindCellDelegate;
                coll.ReuseId = reuseId;
                return coll;
