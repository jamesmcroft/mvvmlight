// ****************************************************************************
// <copyright file="ObservableTableViewController.iOS.cs" company="GalaSoft Laurent Bugnion">
...
namespace GalaSoft.MvvmLight.Helpers
{
    ...
    public class ObservableTableViewController<T> : UITableViewController, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public UITableViewSource TableSource => this.tableSource;
        ...
        public override UITableView TableView
        {
            ...
            set
            {
                ...
                base.TableView.Source = this.tableSource ?? this.CreateSource();
        ...
        {
            this.tableSource = new ObservableTableSource<T>(this) { ReuseId = this.ReuseId };
        ...
        private void HandleCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            Action act = () =>
            {
                ...
                else if (e.Action == NotifyCollectionChangedAction.Remove)
                {
                    ...
                    this.TableView.DeleteRows(paths, this.DeleteAnimation);
                }
            };
        ...
        {
            private readonly ObservableTableViewController<T2> controller;
            ...
            {
                UITableViewCell cell = tableView.DequeueReusableCell(this.NsReuseId) ?? this.controller.CreateCell(this.NsReuseId);

                try
                {
                    IList<T2> coll = this.controller.dataSource;
            ...
            {
                return this.controller.GetHeightForFooterDelegate?.Invoke(tableView, section) ?? 0;
            }
            ...
            {
                return this.controller.GetHeightForHeaderDelegate?.Invoke(tableView, section) ?? 0;
            }
            ...
            {
                return this.controller.GetViewForFooterDelegate != null ? this.controller.GetViewForFooterDelegate(tableView, section) : base.GetViewForFooter(tableView, section);
            }
            ...
            {
                return this.controller.GetViewForHeaderDelegate != null ? this.controller.GetViewForHeaderDelegate(tableView, section) : base.GetViewForHeader(tableView, section);
            }
            ...
            {
                T2 item = this.controller.dataSource != null ? this.controller.dataSource[indexPath.Row] : default(T2);
